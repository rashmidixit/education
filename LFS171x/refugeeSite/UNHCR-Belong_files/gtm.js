...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=\"\";",["escape",["macro",0],8,16],".hasAttribute(\"name\")\u0026\u0026(a=",["escape",["macro",0],8,16],".getAttribute(\"name\"));return a})();"]
    },{
      "function":"__jsm",
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=document.getElementsByTagName(\"video\");for(a=a.length;a--;)return!0;return!1})();"]
    },{
      "function":"__u",
      "vtp_component":"URL"
    },{
      ...
      "function":"__c",
      "vtp_value":"UA-1473340-17"
    },{
      "function":"__c",
      "vtp_value":"unhcr.org,unhcr.fr,unhcr-arabic.org,acnur.org,unhcr.org.uk,unhcr.be,unhcr.nl,acnur.org.br"
    },{
      "function":"__aev",
      "vtp_varType":"URL"
    },{
  ...
  "tags":[{
      ...
      "priority":1,
      "once_per_event":true,
      "vtp_html":"\u003Cscript data-gtmsrc=\"https:\/\/static.unhcr.org\/js\/cookie-consent.js\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\"\u003Edo_consent_verification();\u003C\/script\u003E",
      ...
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_contentGroup":["list"],
      "vtp_dimension":["list",["map","index","3","dimension","Website_IBelong"]],
      "vtp_metric":["list"],
      "vtp_useDebugVersion":false,
      "vtp_autoLinkDomains":["macro",8],
      "vtp_enableLinkId":false,
      ...
      "function":"__html",
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Evar myPlayer=videojs(\"campaign_html5_api\"),videoTitle=\"campaign_html5_api\";\nmyPlayer.ready(function(){var a=0;this.on(\"loadedmetadata\",function(){});this.on(\"play\",function(){dataLayer.push({event:\"video\",action:\"play\",label:videoTitle})});this.on(\"pause\",function(){Math.round(this.currentTime())!=Math.round(this.duration())\u0026\u0026dataLayer.push({event:\"video\",action:\"pause\",label:videoTitle})});this.on(\"error\",function(){dataLayer.push({event:\"error\",action:\"GTM\",label:\"video:\"+videoTitle})});this.on(\"timeupdate\",function(){var b=1.5\u003E=this.duration()-this.currentTime()?1:(Math.floor(this.currentTime()\/\nthis.duration()*4)\/4).toFixed(2);console.log(\"time: \"+b);if(!a||b\u003Ea)a=b,dataLayer.push({event:\"video\",action:100*b+\"%\",label:videoTitle});1!=a})});\u003C\/script\u003E",
      "vtp_convertJsValuesToExpressions":true,
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      ...
      "once_per_event":true,
      "vtp_supportDocumentWrite":false,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Ewindow.location=\"http:\/\/www.unhcr.org\/ibelong\";\u003C\/script\u003E",
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":17
    }],
  "predicates":[{
      ...
      "function":"_re",
      "arg0":["macro",10],
      "arg1":".*unhcr.*|.*acnur.*|.*(unhcr\\.it|angelodeirifugiati\\.it|routineisfantastic\\.it).*|.*unrefugees\\.org.*",
      "ignore_case":true
    },{
      "function":"_eq",
      "arg0":["macro",5],
      ...
      "function":"_sw",
      "arg0":["macro",4],
      "arg1":"http:\/\/ibelong.unhcr.org\/"
    }],
  "rules":[
    [["if",0,1],["add",1,3,0]],
    [["if",1,2],["add",2,10]],
    [["if",3,5],["unless",4],["add",4]],
    [["if",6],["add",5]],
    [["if",5,7],["add",6]],
    [["if",8],["add",7]],
    [["if",9],["add",8]],
