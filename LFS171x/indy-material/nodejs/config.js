...
const config = {
    ...
    walletName: `${process.env.USERNAME || 'aswathi'}_wallet`,
    ...
    userInformation: {
        name: process.env.NAME || 'Aswathi S.',
        email: process.env.EMAIL || 'aswathi@faber.edu',
        ...
        username: process.env.USERNAME || 'aswathi',
